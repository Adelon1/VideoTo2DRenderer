...
# ============================================================
# Desmos screenshot settings
# ============================================================

# Desmos asyncScreenshot() generates the PNG.
...
# Increase for higher-resolution output at the same CSS size.
...
# Output PNG size generated by Desmos asyncScreenshot().
SCREENSHOT_WIDTH = 1920
SCREENSHOT_HEIGHT = 1080

# Hide HTML buttons/toolbars while rendering.
# This is mostly for visual debugging, because screenshots come directly
# from Desmos asyncScreenshot().
